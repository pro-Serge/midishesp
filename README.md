...
Если установлен хотя бы один из старших трех битов, получаем один пакет с таким же значением третьего байта, как и в запросе: отправляем 10h, получаем 10h, отправляем 20h, получаем 20h и т.д.
